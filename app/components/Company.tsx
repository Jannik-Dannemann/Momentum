    ...
    >
      <div className="max-w-screen-xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div data-company-card className="text-center">
            <img src="https://placehold.co/400x400/fadbc5/3D453A?text=LI" alt="Team Member 2" className="w-48 h-48 rounded-full mx-auto mb-4 object-cover border-4 border-secondary"/>
            <h3 className="text-2xl font-bold text-foreground">Leo Ipsum</h3>
            <p className="text-foreground/70">Lead Designer</p>
          </div>
          
          <div data-company-card className="text-center">
            <img src="https://placehold.co/400x400/a2e4b8/3D453A?text=CH" alt="Team Member 3" className="w-48 h-48 rounded-full mx-auto mb-4 object-cover border-4 border-primary"/>
            <h3 className="text-2xl font-bold text-foreground">Chloe Hue</h3>
            <p className="text-foreground/70">Head of Engineering</p>
          </div>
          
          <div data-company-card className="text-center">
            <img src="https://placehold.co/400x400/fadbc5/3D453A?text=MA" alt="Team Member 4" className="w-48 h-48 rounded-full mx-auto mb-4 object-cover border-4 border-secondary"/>
