...
// This component is now "dumb" and only handles its own content.
const Pricing = () => {
  return (
    // This wrapper div is the new target for the parent's pin animation
    <div id="pricing-container" className="relative">
      ...
      >
        <div className="max-w-screen-xl mx-auto">
          {/* ... all your pricing card content remains exactly the same ... */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div data-pricing-card className="bg-secondary/20 p-8 rounded-2xl transition-transform duration-300 ease-in-out hover:scale-105 hover:shadow-xl">
              ...
              <button className="w-full bg-foreground text-background font-bold py-3 rounded-lg transition-colors duration-300 hover:bg-foreground/80">Get Started</button>
            </div>
            <div data-pricing-card className="bg-background p-8 rounded-2xl shadow-2xl shadow-primary/20 border-2 border-primary relative transition-transform duration-300 ease-in-out hover:scale-105 hover:shadow-primary/40">
              ...
              <button className="w-full bg-primary text-primary-foreground font-bold py-3 rounded-lg transition-colors duration-300 hover:bg-primary/80">Choose Pro</button>
            </div>
            <div data-pricing-card className="bg-secondary/20 p-8 rounded-2xl transition-transform duration-300 ease-in-out hover:scale-105 hover:shadow-xl">
              ...
              <button className="w-full bg-foreground text-background font-bold py-3 rounded-lg transition-colors duration-300 hover:bg-foreground/80">Contact Us</button>
            </div>
          </div>
        </div>
      </section>
